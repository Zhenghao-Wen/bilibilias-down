...
[![Build(Encrypted)](https://github.com/Zhenghao-Wen/bilibilias-down/actions/workflows/build-apk-alpha.yml/badge.svg)](https://github.com/Zhenghao-Wen/bilibilias-down/actions/workflows/build-apk-alpha.yml)
...
> [!WARNING]
> 官方仓库已恢复维护，Alpha编译可自行前往[Actions](https://github.com/1250422131/bilibilias/actions/workflows/build-apk-alpha.yml)了解，可以方便确认哪个提交是可正确编译的。
> 
> 本仓库保留的Actions编译脚本依然可以上传产物（但自拉取[3.2.0](https://github.com/1250422131/bilibilias/commit/fbf5f4f21984d4664936797b4c3f8d83c9f9f941)开始，改用加密方式上传，公开渠道无法获取APK包）。
>
> 本仓库保留的存档仅供研究和测试，请在下载后24小时内主动删除。
